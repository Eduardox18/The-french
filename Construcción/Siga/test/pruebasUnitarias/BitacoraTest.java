...
/**
 * Clase que contiene los métodos para probar lso contenidos en la clase Bitacora.
 */
public class BitacoraTest {

    /**
     * Prueba para verificar que el resultado esperado de la recuperacion del número actual de la
     * bitácora sea igual al resultado del método.
     */
    @Test
    ...
    /**
     * Prueba para verificar que el número esperado de la recuperación del último número de bitácora
     * sea igual al resultado del método.
     */
    @Test
    ...
    /**
     * Prueba para verificar que se guardan correctamente las actividades a las que asistió el
     * alumno.
     */
    @Test
    ...
    /**
     * Prueba para verificar que se guardan correctamente las actividades escritas en la base de
     * datos.
     */
    @Test
    ...
    /**
     * Prueba que verifica la fecha actual.
     */
    @Test
    public void fechaActualTest() {
        System.out.println("fechaActual");
        Bitacora fechaActual = new Bitacora();
        LocalDate esperadoResult = LocalDate.now();
        LocalDate resultado = fechaActual.fechaActual();
        assertEquals(esperadoResult, resultado);
    }

    /**
     * Prueba que realiza una comprobación para que el alumno no ingrese una bitácora ya existente
     * en la base de datos, se espera como resultado false, que significa que no se encuentra
     * repetida.
     */
    @Test
